...
function App() {
  ...
  const fetchPlanes = async () => {
    const response = await fetch('https://da84190iyb95z.cloudfront.net/planes')
  ...
  const fetchFlights = async () => {
    const response = await fetch('https://da84190iyb95z.cloudfront.net/flights')
    const data = await response.json()
    setFlightArray(data)
  }
  
  const deleteFlight = async (flightcod) => {
    const response = await fetch(`https://da84190iyb95z.cloudfront.net/flight/${flightcod}`, { method: 'DELETE' })
